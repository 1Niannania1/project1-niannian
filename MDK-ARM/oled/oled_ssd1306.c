...
#endif
#define SSD1306_Write(chr)												OLED_InterfaceWriteData((chr))
#define SSD1306_WriteBuffer(buffer, Size)					OLED_InterfaceWriteBuffer((buffer), (Size))
...
void ssd1306_command(uint8_t com){
	OLED_InterfaceWriteCommand(com);
}
